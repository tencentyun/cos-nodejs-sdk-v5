    ...
    cos.putObject(
      ...
      function (err, data) {
        cos.headObject(
          ...
          function (err, data) {
            assert.ok(data.headers['cache-control'] === 'no-cache' ||
